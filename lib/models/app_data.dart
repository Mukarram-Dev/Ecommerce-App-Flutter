...
class AppData {
  ...
  static List<ProductCategory> categoryList = [
    ...
    ProductCategory(
        ...
        isSelected: true),
    ProductCategory(id: 2, name: "Jacket", image: 'assets/jacket.png'),
    ProductCategory(id: 3, name: "Watch", image: 'assets/watch.png'),
    ProductCategory(id: 4, name: "Watch", image: 'assets/watch.png'),
  ];
